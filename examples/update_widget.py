...
def update_widget():
    ...
    try:
        page, page_size = 1, 1
        resp_page = client.get_page(Resource.WIDGET, page=page, page_size=page_size,
        ...
        resp_widget = client.update(Resource.WIDGET, results[0]["id"], {"title": "This is my widget"}, "id",
                                    "dashboard")
