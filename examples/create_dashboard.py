...
def create_dashboard():
    ...
    try:
        resp_dashboard = client.create(Resource.DASHBOARD, {"name": "My dashboard"}, "id", "name")
        ...
        widget_body = {"dashboard": dashboard['id'], "title": "My widget", "graph": Graph.TEXT}
        resp_widget = client.create(Resource.WIDGET, widget_body, "id", "title", "graph")
